 ...
 */
public class TripleExtractorSindiceCacheAPI implements TripleExtractor {

    private SindiceAPIProxy sindice;
    private int explicit = 1;
    private int implicit = 1;

    public TripleExtractorSindiceCacheAPI(SindiceAPIProxy sindice) {
     ...
     */
    public TripleExtractorSindiceCacheAPI(SindiceAPIProxy sindice, int explicit, int implicit) {
        this.sindice = sindice;
    }
