...
Apache Any23 0.7.0-incubating (tags/any23-0.7.0-incubating/core@r1358077; 2012-07-06 10:41:50+0200)
  ...
  The most up-to-date documentation can be found at http://incubator.apache.org/any23.

  Release Notes
  -------------

  The full list of changes can be found at http://incubator.apache.org/any23/changes-report.html.
...
** Windows 2000/XP
  ...
  1) Unzip the distribution archive, i.e. apache-any23-0.7.0-incubating-bin.zip to the directory you wish to
        install Apache Any23 0.7.0-incubating.
        These instructions assume you chose C:\Program Files\Apache Software Foundation.
        The subdirectory apache-any23-0.7.0-incubating will be created from the archive.
  ...
  2) Add the ANY23_HOME environment variable by opening up the system properties (WinKey + Pause),
        ...
        C:\Program Files\Apache Software Foundation\apache-any23-0.7.0-incubating.
...
** Unix-based Operating Systems (Linux, Solaris and Mac OS X)
  ...
  1) Extract the distribution archive, i.e. apache-any23-0.7.0-incubating-bin.tar.gz to the directory you wish to
        install Apache Any23 0.7.0-incubating.
  ...
  2) In a command terminal, add the ANY23_HOME environment variable, e.g.
        export ANY23_HOME=/usr/local/apache-any23/apache-any23-0.7.0-incubating.
  ...
  Downloads:          http://incubator.apache.org/any23/download.html
  Release Notes:      http://incubator.apache.org/any23/changes-report.html
  Mailing Lists:      http://incubator.apache.org/any23/mail-lists.html
  Source Code:        https://svn.apache.org/viewvc/incubator/any23/tags/any23-0.7.0-incubating
  Issue Tracking:     https://issues.apache.org/jira/browse/ANY23
  Available Plugins:  http://incubator.apache.org/any23/plugins.html
