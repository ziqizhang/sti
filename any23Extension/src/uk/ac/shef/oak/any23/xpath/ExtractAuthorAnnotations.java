...
public class ExtractAuthorAnnotations {

	public ExtractAuthorAnnotations(String queryFile, String resultFile) {
		super();
	...
	public ExtractAuthorAnnotations(String queryFile, String resultFile, int maxNumberOfSindiceResultPages) {
		super();
		this.queryFile = queryFile;
		this.resultFile = resultFile;
...
//				if ((s.getpXPath().contains("@itemprop"))){
	...
	public static void main(String[] args) throws IOException {
		ExtractAuthorAnnotations eba;
		if (args[2]!=null){
			int max = Integer.valueOf(args[2]);
			 eba = new ExtractAuthorAnnotations(args[0], args[1], max);
		}else{
			eba = new ExtractAuthorAnnotations(args[0], args[1]);
		}
