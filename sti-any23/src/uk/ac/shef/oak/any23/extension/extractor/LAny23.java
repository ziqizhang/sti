...
public class LAny23 {
     ...
     */
    public LAny23(Configuration configuration, ExtractorGroup extractorGroup) {
        ...
        this.factories = (extractorGroup == null)
                ? LExtractorRegistry.getInstance().getExtractorGroup()
                : extractorGroup;
     ...
     * @param extractorGroup the group of extractors to be applied.
     */
    public LAny23(ExtractorGroup extractorGroup) {
     ...
     */
    public LAny23(Configuration configuration, String... extractorNames) {
        this(
                configuration,
                extractorNames == null
                        ?
                        null
                        :
                        LExtractorRegistry.getInstance().getExtractorGroup(Arrays.asList(extractorNames))
        );
    }
     ...
     * @param extractorNames list of extractor's names.
     */
    public LAny23(String... extractorNames) {
     ...
     */
    public LAny23(Configuration configuration) {
    ...
    public HTTPClient getHTTPClient() throws IOException {
        if (!httpClientInitialized) {
            if (userAgent == null) {
                throw new IOException("Must call " + LAny23.class.getSimpleName() +
    ...
    public ExtractionReport extract(
        ...
        final LSingleDocumentExtraction ex = new LSingleDocumentExtraction(configuration, in, factories, outputHandler);
