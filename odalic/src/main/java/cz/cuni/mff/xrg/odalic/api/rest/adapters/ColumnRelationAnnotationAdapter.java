...
public class ColumnRelationAnnotationAdapter
    extends XmlAdapter<ColumnRelationAnnotationValue, ColumnRelationAnnotation> {

  @Override
  public ColumnRelationAnnotationValue marshal(ColumnRelationAnnotation bound)
      throws Exception {
    return new ColumnRelationAnnotationValue(bound);
  }

  @Override
  public ColumnRelationAnnotation unmarshal(ColumnRelationAnnotationValue value)
      throws Exception {
