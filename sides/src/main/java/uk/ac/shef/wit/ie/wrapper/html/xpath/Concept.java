...
public class Concept
{
    ...
    public static final int A_HREF = 0x02;
    public static final int IMG_SRC = 0x04;

    private String name;
    private int flag;
    private Pattern pattern;

    public Concept(final String name, final int flag)
    {
        this(name, flag, null);
    }

    public Concept(final String name, final int flag, final Pattern pattern)
    {
        this.name = name;
        this.flag = flag;
