...
public class Relation
{
    public static enum Cardinality
    {
        ...
        public static Cardinality getInverse(final Cardinality cardinality)
        {
            switch (cardinality)
            {
                case ONE_TO_MANY:
        ...
        public static boolean isSingleSource(final Cardinality cardinality)
        {
            return cardinality == ONE_TO_ONE || cardinality == ONE_TO_MANY;
        }

        public static boolean isSingleRecipient(final Cardinality cardinality)
        {
