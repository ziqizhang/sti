 ...
 */
public class TableParserGoodreads extends TableParser {
    public TableParserGoodreads(TableNormalizer normalizer, TableHODetector detector, TableObjCreator creator, TableValidator... validators) {
