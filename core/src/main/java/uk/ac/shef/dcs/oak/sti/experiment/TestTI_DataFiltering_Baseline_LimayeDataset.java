...
/**
 */
public class TestTI_DataFiltering_Baseline_LimayeDataset {
    private static Logger log = Logger.getLogger(TestTI_DataFiltering_Baseline_LimayeDataset.class.getName());
...
/*        freebaseMatcher.find_typesForEntityId("/m/02hrh1q");
        ...
        Disambiguator disambiguator = new Disambiguator(
                freebaseMatcher,
                new DisambiguationScorer_Baseline(
                        stopWords,
        ...
        ClassificationScorer class_scorer = new ClassificationScorer_Baseline(
                nlpResources,
