package uk.ac.shef.dcs.oak.sti.deprecated_table_list.xtractor.gwtwiki;
...
import uk.ac.shef.dcs.oak.sti.deprecated_table_list.xtractor.ListXtractor;
    ...
    public void process(WikiArticle page, Siteinfo siteinfo) throws SAXException {
        ...
        if (page.isMain()&&page.getText()!=null) {
            ...
            if (textLowerCase.indexOf("wikitable") != -1) { //it likely contains tables or lists
                List<LTable> tables = tXtractor.extract(page.getText(),
