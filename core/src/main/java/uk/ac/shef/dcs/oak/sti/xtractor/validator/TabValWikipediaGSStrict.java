package uk.ac.shef.dcs.oak.sti.xtractor.validator;
 ...
 */
@Deprecated
public class TabValWikipediaGSStrict extends TabValGeneric {
    ...
    protected static final double THRESHOLD_MIN_FRAC_CELLS_WITH_URIS_IN_COLUMN = 0.5;
    ...
    public TabValWikipediaGSStrict() {
    }
