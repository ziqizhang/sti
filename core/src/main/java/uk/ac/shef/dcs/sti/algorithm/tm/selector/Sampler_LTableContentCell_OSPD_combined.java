 ...
 */
public class Sampler_LTableContentCell_OSPD_combined extends CellSelector {
    private List<String> stopwords = new ArrayList<String>();

    public Sampler_LTableContentCell_OSPD_combined(List<String> stopwords) {
    ...
    public List<List<Integer>> select(LTable table, int fromCol, int subCol) {
        ...
        if (TableMinerConstants.ENFORCE_OSPD && fromCol != subCol) {
            ...
            for (Map.Entry<String, List<Integer>> entry : grouped.entrySet()) {
                ...
                LTableContentCell tcc_at_focus = table.getContentCell(rows.get(0), fromCol);
