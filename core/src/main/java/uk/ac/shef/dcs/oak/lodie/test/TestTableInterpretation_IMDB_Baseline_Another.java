 ...
 */
public class TestTableInterpretation_IMDB_Baseline_Another {
    private static Logger log = Logger.getLogger(TestTableInterpretation_IMDB_Baseline_Another.class.getName());
        ...
        for (File f : all) {
            ...
            try {
                ...
                if (!complete) {
                    ...
                    try {
                        missedWriter = new PrintWriter(new FileWriter("ti_imdb_missed_base_another.csv", true));
