 ...
 */
public class ClassificationScorer_Vote implements ClassificationScorer {
    ...
    public ClassificationScorer_Vote(String nlpResources, Creator_OntologyEntityHierarchicalBOW bow_creator, List<String> stopWords,
    ...
    private List<String> create_header_other_bow(List<String> bag_of_words_for_header, LTable table, int column) {
        if (bag_of_words_for_header != null)
            return bag_of_words_for_header;
        List<String> bow = new ArrayList<String>();
        for (int c = 0; c < table.getNumCols(); c++) {
