...
public class Table_ContextExtractor_IMDB {
    ...
    public static List<LTableContext> extract_tripleContexts(String file, Document doc) throws LodieException {
    ...
    public static List<LTableContext> extract_otherContexts(String file, Document doc) throws LodieException {
        //triple contexts
        List<LTableContext> contexts = new ArrayList<LTableContext>();
