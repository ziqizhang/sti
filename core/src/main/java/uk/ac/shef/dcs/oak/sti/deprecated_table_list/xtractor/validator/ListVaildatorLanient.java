package uk.ac.shef.dcs.oak.sti.deprecated_table_list.xtractor.validator;

import uk.ac.shef.dcs.oak.sti.deprecated_table_list.model.LList;
import uk.ac.shef.dcs.oak.sti.deprecated_table_list.model.LListItem;
import uk.ac.shef.dcs.oak.sti.table.validator.ContentValidator;
...
public class ListVaildatorLanient extends ContentValidator implements ListValidator {
    ...
    protected static int THRESHOLD_MIN_PROPERITEMS=5;
    protected static int THRESHOLD_MAX_TOKENS_PER_VALUEINITEM = 5; //above this value, this value in the item is "lengthy", as a result, the item is lengthy
    protected static int THRESHOLD_MAX_VALUES_PER_ITEM = 3; //above this value, this list item is "lengthy"

    protected static double THRESHOLD_TOOMANY_LENGTHYITEM = 0.2; //% of lengthy items allowed in a list
    protected static double THRESHOLD_TOOMANY_NUMERICITEMS = 0.2;
