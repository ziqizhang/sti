...
import uk.ac.shef.dcs.oak.sti.table.rep.LTableColumnHeader;
...
public class ColumnFeatureGenerator {
    ...
    public ColumnFeatureGenerator(String cache, String nlpResource,
        ...
        websearchMatcher = new HeaderWebsearchMatcher_token(
                new HeaderWebsearchMatcherCache(cache, "collection1"),
                new BingWebSearch(searchAPIKeys),
                stopWords);
    ...
    //
    public void feature_countEmptyCells(List<ColumnFeature> features, LTable table) {
    ...
    public static void feature_columnDataTypes(LTable table) {
    ...
    public static void feature_mostDataType(List<ColumnFeature> features, LTable table) {
        for (ColumnFeature cf : features) {
            int col = cf.getColId();
    ...
    public void feature_valueDiversity(List<ColumnFeature> features, LTable table) {
        for (ColumnFeature cf : features) {
            int col = cf.getColId();
    ...
    public void feature_contextMatchScore(List<ColumnFeature> features, LTable table) {
    ...
    public DoubleMatrix2D feature_webSearchScore(List<ColumnFeature> features, LTable table) throws APIKeysDepletedException, IOException {
    ...
    public void feature_headerInvalidSyntactic(List<ColumnFeature> allNEColumnCandidates, LTable table) {
    ...
    public void feature_isColumnAcronymOrCode(List<ColumnFeature> allNEColumnCandidates, LTable table) {
        for (ColumnFeature cf : allNEColumnCandidates) {
            int col = cf.getColId();
