...
public class Table_ContextExtractor_Generic {
    public static List<LTableContext> extractTableContexts(String file, Document doc) throws LodieException {
    ...
    public static List<LTableContext> extractTableContexts_generic_everything(String file, Document doc) throws LodieException {
        //triple contexts
        List<LTableContext> contexts = new ArrayList<LTableContext>();
