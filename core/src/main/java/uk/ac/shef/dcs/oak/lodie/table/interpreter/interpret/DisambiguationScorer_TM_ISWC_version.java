 ...
 */
public class DisambiguationScorer_TM_ISWC_version implements DisambiguationScorer {
     ...
     */
    public DisambiguationScorer_TM_ISWC_version(
...
*/
    ...
    @Deprecated
    /*public static double compute_final_score(Map<String, Double> scoreMap, String cellTextOriginal) {
        double sum = 0.0;
