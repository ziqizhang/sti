...
public class TripleGenerator {
    ...
    public List<LTableTriple> generate_newTriples(LTableAnnotation tab_annotation, LTable table) {
        ...
        Map<Key_SubjectCol_ObjectCol, List<HeaderBinaryRelationAnnotation>> relations_across_columns = tab_annotation.getRelationAnnotations_across_columns();
        for (Map.Entry<Key_SubjectCol_ObjectCol, List<HeaderBinaryRelationAnnotation>> entry : relations_across_columns.entrySet()) {
