...
import uk.ac.shef.dcs.sti.core.algorithm.tm.*;
import uk.ac.shef.dcs.sti.core.algorithm.tmp.sampler.Random;
import uk.ac.shef.dcs.sti.io.TAnnotationWriter;
import uk.ac.shef.dcs.sti.core.algorithm.tmp.sampler.*;
...
/*        freebaseMatcher.find_typesForEntityId("/m/02hrh1q");
        ...
        if (cellSelector == 0) {
            ...
            selector=new OSPD_namelength_merge();
