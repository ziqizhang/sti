 ...
 */
public class LSingleDocumentExtraction {
     ...
     */
    public LSingleDocumentExtraction(
        ...
        if(!(output instanceof LNTripleWriter)) throw new IllegalArgumentException(LNTripleWriter.class.getName()+" required!");
    ...
    private SingleExtractionReport runExtractor(
        ...
        final LExtractionResultImpl extractionResult = new LExtractionResultImpl(extractionContext, extractor, (LNTripleWriter)output);
        try {
